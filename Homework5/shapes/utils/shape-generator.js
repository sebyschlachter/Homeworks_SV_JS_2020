...
export const generateNewShape = (cells) => {
    ...
    switch (index) {
        case 0:
            return new I(0, 3, cells);
        case 1:
            return new J(0, 3, cells);
        case 2:
            return new L(0, 3, cells);
        case 3:
            return new O(0, 3, cells);
        case 4:
            return new S(0, 3, cells);
        case 5:
            return new T(0, 3, cells);
        case 6:
            return new Z(0, 3, cells);
    }
}